...
// import 'package:video_editer/frame_row.dart';

// class TrimmerAndSplit extends StatefulWidget {
//   const TrimmerAndSplit({super.key});
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text("Trimmer and Split"),
//       ),
//       body: (spriteSheetImage == null)
...
//                 children: [
//                   Text(
//                     "Frame at white line: ${clampedIndex + 1} \n"
//                     "Time: ${currentTime.toStringAsFixed(2)}s \n"
//                     "Total Time: ${totalTime.toStringAsFixed(2)}s \n"
//                     "Total Groups: ${frameGroups.length}",
//                   ),
//                   SizedBox(height: 20),
//                   SizedBox(
//                     height: 30,
...
//                       itemCount: (timeInfoList.fold(0.0, (sum, timeInfo) => sum + timeInfo['totalWidth']) / frameWidth)
//                               .ceil() +
//                           2, // +2 for padding
...
//                             timeInfoList.fold(0.0, (sum, timeInfo) => sum + timeInfo['totalTimeDuration']);

//                         // Handle padding logic for the first and last items
//                         if (index == 0) {
//                           return SizedBox(width: redLinePosition); // Padding at the start
//                         } else if (index ==
//                             (timeInfoList.fold(0.0, (sum, timeInfo) => sum + timeInfo['totalWidth']) / frameWidth)
//                                     .ceil() +
//                                 1) {
...
//                                 children: [
//                                   if (groupIndex == 0) SizedBox(width: redLinePosition), // Left padding
//                                   FrameRow(
...
//                                     SizedBox(width: redLinePosition - 24), // Right padding
//                                 ],
//                               ),
//                             );
//                           },
...
//                     child: Text(
//                       "${currentTime.toStringAsFixed(2)} sec",
